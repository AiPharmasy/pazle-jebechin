// Generate all app icon sizes from v2 design
...
async function main() {
  ...
  await page.goto('file:///home/z/my-project/scripts/app-icon-v3.html')
  ...
  for (const { size, name } of sizes) {
    await page.evaluate((s) => {
      ...
      if (icon) {
        ...
        // Squircle proportion: 115/512 ≈ 0.224
        icon.style.borderRadius = Math.floor(s * 0.224) + 'px'
      }
    }, size)
